...
<<<<<<< HEAD
```{r, fig.cap="Figure #3: Relationship between the ln transformed number of offspring a mother produces per a year during her life span as predicted by the linear mixed-effects model of 7 mammalian orders. The long black line represents the overall trend where each coloured line represents the trend for each mammalian order. The dots represent the raw data points."}
...
#library(lme4)
>>>>>>> 38196c545656783e6cbb6ae09e87a018dd549c6b
